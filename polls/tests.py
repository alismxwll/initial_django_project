...
def create_question(question_text, days):
    ...
    the given number of 'days' offset to now (negative for the
    questions published in the past, positive for the questions
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_no_questions(self):
        """
        if not questions exist, an appropriate message should be
        displayed
        """
    ...
    def test_index_view_with_future_question_and_past_questions(self):
        """
        Even if both past and future question exist, on past
